...
const isCrawler = (function(a){if(/bot|googlebot|crawler|spider|robot|crawling/i.test(a.substr(0,4)))return true; else return false;})(navigator.userAgent||navigator.vendor||window.opera);
