...
const isCrawler = (function(a){if(/bot|googlebot|crawler|spider|robot|crawling|chrome-lighthouse|Google Page Speed Insights/i.test(a.substr(0,4)))return true; else return false;})(navigator.userAgent||navigator.vendor||window.opera);
