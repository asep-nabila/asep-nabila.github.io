...
const createcalamnsielement = function(){
	...
	$("#calamansiplaycontroler").html('<span class="calamansi" data-skin="//cdn.jsdelivr.net/gh/maunklana/calamansi@master/skins/in-text" data-source="music/'+p.file+'"></span>');
	...
	if(!dari || !kenalan){
		Swal.fire({
			...
			<select id="geustcollegue" class="form-select swall-input-ask text-light" aria-label="Default select Kenalan" required>
				<option value="" selected="">Kenalan/Teman dari?</option>
